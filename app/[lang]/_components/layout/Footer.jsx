...
import { AppbarFullLogo } from "../styledComponents";
import logo from "../../../../public/images/onlycoders_logo2.webp";
			...
			<Box sx={{ width: "100%", maxWidth: "1400px" }}>
				<Grid container spacing={4}>
					...
					<Grid size={{ xs: 12, md: 4 }} sx={{ mb: 4 }}>
						<AppbarFullLogo src={logo.src} alt="Full" style={{ marginLeft: -10, marginBottom: 15 }} />
